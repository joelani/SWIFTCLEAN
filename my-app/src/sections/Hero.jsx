...
const Hero = () => {
  ...
  return (
    <section id='hero' className='bg-gradient-to-br from-[#F7F9FC] via-white to-blue-50'>
    <div className='container  relative m-auto py-12 md:px-20 px-14 overflow-hidden'>
      <div className='relative z-10 text-center flex flex-col gap-9 justify-center items-center'>
      ...
      {/**Achievement */}
      <div className='mt-7 grid grid-cols-2 md:grid-cols-4 gap-8 text-center'>
        <div className='p-6'>
